...
| HR | PARSIAL | Review section operasional, employee master, attendance, dan loan awal sudah bisa create |
...
| HR shell: employee, attendance, salary, loan | PARSIAL | Review employee, attendance, loan, create employee master, create attendance, dan create loan awal sudah ada | Payroll/slip gaji belum hidup | Tinggi |
