...
| HR | PARSIAL | Review section operasional, employee master, attendance, loan, dan payroll awal sudah bisa create; roadmap attendance wajah + radius sudah dikunci |
...
| HR shell: employee, attendance, salary, loan | PARSIAL | Review employee, attendance, loan, salary slip, create employee master, create attendance, create loan, dan create payroll awal sudah ada | Payroll release lanjutan, face recognition attendance, geofence/radius attendance, dan perhitungan otomatis lebih detail belum hidup | Tinggi |
...
| Audit log dasar | PARSIAL | Audit perubahan import batch, user internal, permission, dan role-permission sudah bisa dibaca terpusat di dashboard | Belum mencakup write action sales, support, billing, inventory, HR, dan modul lain secara menyeluruh | Tinggi |
