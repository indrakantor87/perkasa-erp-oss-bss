...
LABEL coolify.helper_image="ghcr.io/coollabsio/coolify-helper:1.0.13"
LABEL coolify.builder.helper="0"
LABEL coolify.build.builder="default"
LABEL coolify.build.driver="docker-legacy"
