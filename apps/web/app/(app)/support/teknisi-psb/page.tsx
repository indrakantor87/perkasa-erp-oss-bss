...
const LANE_KEY = 'PSB'
const LANE_TITLE = 'Lane PSB (Pemasangan Baru)'
const LANE_EYEBROW = 'Lapangan • Support'
const LANE_DESCRIPTION =
  'Daftar tiket Pemasangan Baru (PSB) yang ditugaskan kepada Anda. Terima assignment, mulai pengerjaan lapangan, dan submit hasil sesuai SLA.'
const TICKET_TYPE_LABEL = 'PSB'

function resolveSearchParam(value: string | string[] | undefined) {
  return Array.isArray(value) ? value[0] : value
}

export default async function TeknisiPsbLanePage({
  searchParams,
}: {
