...
const LANE_KEY = 'DISMANTLE'
const LANE_TITLE = 'Lane Dismantle (Pencabutan)'
const LANE_EYEBROW = 'Lapangan • Support'
const LANE_DESCRIPTION =
  'Daftar tiket Dismantle / Pencabutan perangkat yang ditugaskan kepada Anda. Pastikan penarikan perangkat tercatat dengan evidence lengkap sebelum submit hasil.'
const TICKET_TYPE_LABEL = 'DISMANTLE'

function resolveSearchParam(value: string | string[] | undefined) {
  return Array.isArray(value) ? value[0] : value
}

export default async function TeknisiDismantleLanePage({
  searchParams,
}: {
