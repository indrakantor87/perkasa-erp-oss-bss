...
const LANE_KEY = 'TROUBLE'
const LANE_TITLE = 'Lane Troubleshoots (Gangguan)'
const LANE_EYEBROW = 'Lapangan • Support'
const LANE_DESCRIPTION =
  'Daftar tiket Troubleshoot / Gangguan pelanggan yang ditugaskan kepada Anda. Gunakan tombol Temporary untuk menangguhkan pekerjaan (misal menunggu material) dan Resume untuk melanjutkan kembali.'
const TICKET_TYPE_LABEL = 'TROUBLE'

function resolveSearchParam(value: string | string[] | undefined) {
  return Array.isArray(value) ? value[0] : value
}

export default async function TeknisiTroubleshootsLanePage({
  searchParams,
}: {
