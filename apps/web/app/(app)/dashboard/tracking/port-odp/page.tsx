    ...
    <div className="space-y-4">
      ...
      <section className="overflow-hidden rounded-[28px] border border-slate-800 bg-gradient-to-b from-[#071a3e] via-[#0b1f45] to-[#10284f] p-4 shadow-[0_28px_80px_rgba(2,6,23,0.28)]">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-300">Ticketing Perkasa</p>
            ...
            <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-200">
              Halaman ini berdiri sendiri untuk pembacaan kapasitas ODP, status port, marker peta, dan coverage area oleh
              CS maupun NOC tanpa membawa workspace inventory yang tidak relevan ke UI operasional.
            </p>
          </div>
