    ...
    billingCard,
    {
      ...
      metrics: [
        ...
        },
        {
          ...
          hint: 'Queue pembongkaran yang masih perlu tindak lanjut lapangan dan penutupan catatan.',
        },
        {
          label: 'Trouble Jalur',
          value: findMetric(nocCard, 'TICKET PERIODE')?.value ?? '0',
          href: '/dashboard/tracking/noc-queue?ticketType=JALUR',
          hint: 'Pembacaan jalur mengikuti antrian teknis gabungan pada queue NOC agar operator tidak berpindah layar.',
        },
      ],
    },
    {
