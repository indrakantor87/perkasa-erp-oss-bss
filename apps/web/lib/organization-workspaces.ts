...
export const salesWorkspace: OrganizationWorkspaceDefinition = {
  ...
  steps: [
    ...
    },
    {
      ...
      detail: 'CS memilih item, melakukan review, lalu menyiapkan jadwal untuk proses pemasangan.',
    },
    {
      title: 'Masuk Ticket PSB',
      detail: 'Item yang sudah siap diteruskan menjadi ticket PSB untuk jalur operasional lapangan.',
    },
  ],
  sections: [
    {
    ...
    },
    {
      ...
      description: 'Ringkasan perpindahan kerja dari penjualan ke CS lalu ke ticketing.',
      links: [
        {
          label: 'Input Baru',
          href: '/sales/input-psb',
          description: 'Mulai dari form input prospek lapangan yang menjadi satu-satunya pintu masuk penjualan.',
          badge: 'input',
        },
        {
          label: 'Review CS',
          href: '/list-psb?status=REVIEW_CS',
          description: 'Lihat item yang sedang dibaca dan diputuskan oleh tim CS.',
          badge: 'cs',
        },
        {
          label: 'Siap Ticketing',
          href: '/list-psb?status=DISETUJUI',
          description: 'Pantau item yang siap diteruskan ke jalur ticket PSB operasional.',
          badge: 'ticketing',
        },
        {
          label: 'Sudah ke Ticketing',
          href: '/list-psb?status=DITRANSFER_KE_TICKETING',
          description: 'Lihat item yang sudah berubah menjadi ticket PSB untuk monitor progres lanjutannya.',
          badge: 'monitor',
        },
      ],
    },
